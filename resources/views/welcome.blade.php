    ...
    <div class="max-w-6xl mx-auto">
        <section class="-mt-6 max-w-2xl py-32 sm:py-48 lg:-mt-8 lg:py-56">
            ...
            <flux:text class="mt-8 text-lg font-medium text-pretty sm:text-xl/8">
                You want to launch your Laravel app, not waste time configuring servers. With Antifuse, you can provision a
                secure, production-ready VPS for Laravel in just a few clicks—no manual installs, no command-line headaches,
                no guesswork.
            </flux:text>
            <div class="mt-10 flex items-center gap-x-2">
                ...
                <flux:button :href="route('pricing')" variant="ghost" icon:trailing="arrow-right" class="font-semibold">
                    Pricing
                </flux:button>
            </div>
        </section>
            ...
            >
                <div class="relative pl-9">
                    ...
                    <flux:text class="text-base/7" inline>
                        Antifuse automatically installs and configures everything you need: PHP (8.1–8.4), MySQL 8, Redis,
                        and more.
                    </flux:text>
                </div>
                <div class="relative pl-9">
                ...
                <div class="relative pl-9">
                    ...
                    <flux:text class="text-base/7" inline>
                        PHP and MySQL settings are tuned to your server’s specs, so you get peak performance without lifting
                        a finger.
                    </flux:text>
                </div>
                <div class="relative pl-9">
                    ...
                    <flux:text class="text-base/7" inline>
                        Create databases, set up daemons, schedule cron jobs, tweak firewall rules, and restart services—all
                ...
                <div class="relative pl-9">
                    ...
                    <flux:text class="text-base/7" inline>
                        Firewalls are locked down, SSH password logins are disabled, and only your SSH keys grant access.
                        Automated Ubuntu updates keep your server patched—even if you forget.
                    </flux:text>
                </div>
                <div class="relative pl-9">
                    <flux:text variant="strong" class="text-base/7 font-semibold" inline>
            ...
            >
                ...
                <div class="md:-ml-4 lg:ml-0 lg:max-w-lg">
                    <flux:text class="text-lg/8">
                        You’re building Laravel apps for clients or your own projects. You want to move fast, stay secure,
                        and avoid DevOps rabbit holes. Antifuse is for you—even if you’ve never managed a server before.
                    </flux:text>

                    <blockquote class="mt-16 border-l border-zinc-200 pl-8 dark:border-zinc-700">
                        <flux:text class="text-base/7">
                            “I built Antifuse for myself, then opened it to the public so anyone can deploy Laravel apps
                            with ease. It’s fully open source—so you can trust, audit, and contribute.”
                        </flux:text>

                        <div class="mt-6">
                            <flux:text variant="strong" class="text-sm/6 font-semibold" inline>Oliver Servín –</flux:text>
            ...
            <div class="rounded-3xl bg-zinc-50 px-6 py-24 sm:px-16 dark:bg-zinc-900">
                <div class="max-w-2xl">
                    ...
                    <flux:text class="mt-6 text-lg/8">
                        On the Team & Agency plan, you can invite colleagues to manage servers and apps together. No more
                        sharing root passwords or juggling access.
                    </flux:text>
                </div>
            </div>
        </section>
            ...
            >
                ...
                <div class="space-y-8 md:-ml-4 lg:ml-0 lg:max-w-lg">
                    <div class="relative pl-9">
                        ...
                        <flux:text class="text-base/7" inline>
                            Experience effortless Laravel deployments. You’ll need a credit card to begin, but you won’t be
                            charged unless you continue after the trial.
                        </flux:text>
                    </div>
                    <div class="relative pl-9">
                        <flux:text variant="strong" class="text-base/7 font-semibold" inline>
